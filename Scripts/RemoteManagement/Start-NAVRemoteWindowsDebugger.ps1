Function Start-NAVRemoteWindowsDebugger {
    param(
    ...
    Edit-NAVClientUserSettings -ClientUserSettings $clientUserSettings -KeyName 'DnsIdentity' -NewValue (Get-NAVDnsIdentity -SelectedInstance $SelectedInstance)
