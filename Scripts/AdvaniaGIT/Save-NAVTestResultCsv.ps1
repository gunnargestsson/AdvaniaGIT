function Save-NAVTestResultCsv
{
    ...
    $SqlResult = Get-SQLCommandResult -Server $SQLServer -Database $SQLDb -Command $Command -Username $SetupParameters.SqlUsername -Password $SetupParameters.SqlPassword 
