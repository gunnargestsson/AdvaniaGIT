<#
    ...
    .EXAMPLE
    Import-NAVApplicationFobObject MyAppSrc.txt MyApp
    This command imports all application objects in MyAppSrc.txt into the MyApp database.

    .EXAMPLE
    Import-NAVApplicationFobObject MyAppSrc.txt -DatabaseName MyApp
    This command imports all application objects in MyAppSrc.txt into the MyApp database.
    ...
    Kamil Sacek
#>
function Import-NAVApplicationFobObject
{
    ...
    Param(
        ...
        # For version 2018 and later this should be set to 1
        [int16] $GenerateSymbolReference
    BEGIN
    {
    ...
    PROCESS
    {
        ...
        if ($True)
        {
            foreach ($file in $Path)
            {
                ...
                if ($GenerateSymbolReference -eq 1) {
